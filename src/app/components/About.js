          ...
          <div className="md:col-span-7 p-8 md:p-10 bento-card flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-sm sm:text-base text-foreground/75 leading-relaxed">
                ...
                <p>
                  However, my passion for dynamic state management, custom database integrations, and absolute performance led me to dive deep into code. I transitioned into a{" "}
                  <strong className="text-foreground font-semibold">React & Next.js Frontend Engineer</strong>, bringing my acute sense of visual polish into the world of type-safe, optimized modern web systems.
                </p>
                <p>
                  Today, I bridge the gap between creative visual architecture and engineering-grade codebases, focusing on custom state hooks, SEO optimization, and lightning-fast loading speeds.
                </p>
              </div>
            </div>
